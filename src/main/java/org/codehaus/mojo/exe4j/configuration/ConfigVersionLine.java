 ...
 */
public class ConfigVersionLine
    extends ConfigTextLine
{
     ...
     * @param yPos
     */
    public ConfigVersionLine( String fontColour, String fontName, int fontSize, int fontWieght, String text, int xPos,
                             int yPos )
    {
